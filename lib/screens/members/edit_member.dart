...
class _EditMemberScreenState extends State<EditMemberScreen> {
  ...
  late String _gender;
  late String _status;
  String? _selectedPlanId; // This is tricky as we store Plan Name/Type in model, not ID.
  // Ideally we should store PlanID. For now, I'll just let them pick a plan again.
  ...
  void initState() {
    ...
    // Try to match plan name to ID? Or just leave null.
  }
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                hint: Text(widget.member.membershipType), // Show current as hint
                ...
                decoration: const InputDecoration(labelText: 'Change Membership Plan'),
              ),
              const SizedBox(height: 8),
              Row(
                children: [
  ...
  Future<void> _saveMember() async {
    ...
    if (_selectedPlanId != null) {
       ...
       membershipType = plan.name; // Or keep ID? Using name for display as per AddMember.
    }
